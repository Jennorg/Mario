...
import game.manager.KeyManager2;
...
public class Player2 extends Objeto_Juego {

   public static final float ANCHO = 16;
    public static final float ALTO = 16;  
    int n_Golpes = 2;
    GamePanel game;
    KeyManager2 controlManager; 
    ...
    public Player2(KeyManager2 controlManager, ObjetoManager objetoManager, float x, float y, int escala, Textura textura) {
